...
```json
{"ok":true,"path":"/abs/dir/movie.mp4","duration_sec":12.34,"mode":"single","name":"movie","url":"https://example.com/index.m3u8"}
```

## Success (batch)

```json
{"ok":true,"error":"批量完成: 成功=3 跳过=1 失败=0","duration_sec":98.7,"mode":"batch"}
```
